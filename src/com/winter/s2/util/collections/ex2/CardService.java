...
public class CardService {
	...
	public ArrayList<CardDTO> init() {
		...
		while (st.hasMoreTokens()) {
			...
			dto.setContact(st.nextToken().trim());
	...
	// 이름으로 명함 정보 찾기
	public CardDTO findByName(ArrayList<CardDTO> ar) {
		System.out.println("찾고자 하는 명함의 이름을 입력하시오.");
	...
	public ArrayList<CardDTO> removeByName(ArrayList<CardDTO> ar) {
		sc = new Scanner(System.in);
		CardDTO dto = new CardDTO();
